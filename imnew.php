<!DOCTYPE html>
	...
	<div class="container widget-box-area">
		...
		<div class="col-lg-9 col-sm-12"> <!-- outer column with location & time widget boxes nested. To make space for side-nav as a separate column -->
			...
			<div class="col-md-8 col-sm-12">
				<div class="widget-box">
					<div class="lead">
						<strong>Guest Inquiries & Prayer Requests</strong>
					</div>

					<div class="container-fluid"> <!-- This is to avoid horizontal scroll bar in the widget box when form-horizontal is used -->
